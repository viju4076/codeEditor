...
app.get('/:room/interviewer/:pwd/:name',(req,res)=>{
    ...
    res.render('front',{roomId:req.params.room, user:'Interviewer',quesDes:ques,name:req.params.name});
...
app.get('/:room/candidate/:name',(req,res)=>{
    ...
    res.render('front',{roomId:req.params.room,user:'Candidate',quesDes:ques,name:req.params.name})
});
